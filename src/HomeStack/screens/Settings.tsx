...
import { Button, Dimensions, Linking, Switch, Text, TextInput, View, StatusBar, Image } from 'react-native';
  ...
  return (
    <ScrollView style={{ height, marginLeft: 20, marginRight: 20, marginTop: '10%' }} bounces={false} showsVerticalScrollIndicator={false}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', width: '100%' }}>
        <Text style={{ alignSelf: 'flex-start', marginTop: 20, marginBottom: 5, color: '#868383' }}>Beer Size</Text>
      </View>
      <View style={{ flexDirection: 'row', alignItems: 'center', width: '100%', justifyContent: 'space-between' }}>
        <Text style={{ alignSelf: 'flex-start', marginTop: 10, marginBottom: 5, marginLeft: 20, color: '#868383', fontSize: 18 }}>12oz</Text>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', width: '100%', justifyContent: 'space-between' }}>
        <Text style={{ alignSelf: 'flex-start', marginTop: 10, marginBottom: 5, marginLeft: 20, color: '#868383', fontSize: 18 }}>16oz</Text>
        <Switch style={{ alignSelf: 'flex-end' }} onValueChange={() => setNewBeerSize(BeerSize.SIXTEEN_OZ)} value={beerSize === BeerSize.SIXTEEN_OZ} />
      </View>
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', width: '100%' }}>
        <Text style={{ alignSelf: 'flex-start', marginTop: 20, marginBottom: 5, color: '#868383' }}>Temperature</Text>
      </View>
      <View style={{ flexDirection: 'row', alignItems: 'center', width: '100%', justifyContent: 'space-between' }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', width: '100%' }}>
        <Text style={{ alignSelf: 'flex-start', marginTop: 20, marginBottom: 5, color: '#868383' }}>Layout</Text>
      </View>
      <View style={{ flexDirection: 'row', alignItems: 'center', width: '100%', justifyContent: 'space-between' }}>
